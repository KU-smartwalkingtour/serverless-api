...
const runTests = async () => {
    try {
        ...
        assert(coordinates[0].hasOwnProperty('lat') && coordinates[0].hasOwnProperty('lon'), 'Coordinate objects should have lat and lon properties.');
        ...
        assert(typeof metadata === 'object' && metadata !== null, 'getCourseMetadataFromGpx should return an object.');
        assert.strictEqual(metadata['코스명'], '[1코스] 수락산코스', 'Metadata should contain correct course name.');
